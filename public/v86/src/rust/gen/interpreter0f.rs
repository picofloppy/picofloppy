...
match opcode {
    0x00 => {
        ...
        match modrm_byte >> 3 & 7 {
            ...
            x => {
                dbg_log!("#ud F00/{} at {:x}", x, *instruction_pointer);
                trigger_ud();
            }
        }
    },
    ...
    0x01 => {
        ...
        match modrm_byte >> 3 & 7 {
            ...
            x => {
                dbg_log!("#ud F01/{} at {:x}", x, *instruction_pointer);
                trigger_ud();
            }
        }
    },
    ...
    0x10 | 0x110 => {
        ...
        let modrm_byte = match read_imm8() { Ok(o) => o, Err(()) => return };
        if prefixes_ & prefix::PREFIX_66 != 0 {
        ...
        else if prefixes_ & prefix::PREFIX_F2 != 0 {
            if !task_switch_test_mmx() {
                return;
            }
            if modrm_byte < 0xC0 {
            ...
            dbg_assert!((prefixes_ & (prefix::PREFIX_66 | prefix::PREFIX_F2 | prefix::PREFIX_F3)) == 0);
            if !task_switch_test_mmx() {
                return;
            }
            if modrm_byte < 0xC0 {
    ...
    0x52 | 0x152 => {
        let prefixes_ = *prefixes;
        let modrm_byte = match read_imm8() { Ok(o) => o, Err(()) => return };
        if prefixes_ & prefix::PREFIX_F3 != 0 {
            if !task_switch_test_mmx() {
                return;
            }
            if modrm_byte < 0xC0 {
    ...
    0x71 | 0x171 => {
        ...
        if prefixes_ & prefix::PREFIX_66 != 0 {
            match modrm_byte >> 3 & 7 {
                ...
                x => {
                    dbg_log!("#ud 660F71/{} at {:x}", x, *instruction_pointer);
                    trigger_ud();
                }
            }
        }
            ...
            match modrm_byte >> 3 & 7 {
                ...
                x => {
                    dbg_log!("#ud F71/{} at {:x}", x, *instruction_pointer);
                    trigger_ud();
                }
            }
        }
    ...
    0x72 | 0x172 => {
        ...
        if prefixes_ & prefix::PREFIX_66 != 0 {
            match modrm_byte >> 3 & 7 {
                ...
                x => {
                    dbg_log!("#ud 660F72/{} at {:x}", x, *instruction_pointer);
                    trigger_ud();
                }
            }
        }
            ...
            match modrm_byte >> 3 & 7 {
                ...
                x => {
                    dbg_log!("#ud F72/{} at {:x}", x, *instruction_pointer);
                    trigger_ud();
                }
            }
        }
    ...
    0x73 | 0x173 => {
        ...
        if prefixes_ & prefix::PREFIX_66 != 0 {
            match modrm_byte >> 3 & 7 {
                ...
                x => {
                    dbg_log!("#ud 660F73/{} at {:x}", x, *instruction_pointer);
                    trigger_ud();
                }
            }
        }
            ...
            match modrm_byte >> 3 & 7 {
                ...
                x => {
                    dbg_log!("#ud F73/{} at {:x}", x, *instruction_pointer);
                    trigger_ud();
                }
            }
        }
    ...
    0x7C | 0x17C => {
        ...
        if prefixes_ & prefix::PREFIX_66 != 0 {
            ...
            if modrm_byte < 0xC0 {
                instructions_0f::instr_660F7C_mem(match modrm_resolve(modrm_byte) { Ok(a) => a, Err(()) => return }, modrm_byte >> 3 & 7);
            }
            else {
                instructions_0f::instr_660F7C_reg(modrm_byte & 7, modrm_byte >> 3 & 7);
            }
        }
        else if prefixes_ & prefix::PREFIX_F2 != 0 {
            if !task_switch_test_mmx() {
            ...
            if modrm_byte < 0xC0 {
                instructions_0f::instr_F20F7C_mem(match modrm_resolve(modrm_byte) { Ok(a) => a, Err(()) => return }, modrm_byte >> 3 & 7);
            }
            else {
                instructions_0f::instr_F20F7C_reg(modrm_byte & 7, modrm_byte >> 3 & 7);
            }
        }
        else {
            dbg_assert!((prefixes_ & (prefix::PREFIX_66 | prefix::PREFIX_F2 | prefix::PREFIX_F3)) == 0);
    ...
    0x7D | 0x17D => {
        ...
        if prefixes_ & prefix::PREFIX_66 != 0 {
            ...
            if modrm_byte < 0xC0 {
                instructions_0f::instr_660F7D_mem(match modrm_resolve(modrm_byte) { Ok(a) => a, Err(()) => return }, modrm_byte >> 3 & 7);
            }
            else {
                instructions_0f::instr_660F7D_reg(modrm_byte & 7, modrm_byte >> 3 & 7);
            }
        }
        else if prefixes_ & prefix::PREFIX_F2 != 0 {
            if !task_switch_test_mmx() {
            ...
            if modrm_byte < 0xC0 {
                instructions_0f::instr_F20F7D_mem(match modrm_resolve(modrm_byte) { Ok(a) => a, Err(()) => return }, modrm_byte >> 3 & 7);
            }
            else {
                instructions_0f::instr_F20F7D_reg(modrm_byte & 7, modrm_byte >> 3 & 7);
            }
        }
        else {
            dbg_assert!((prefixes_ & (prefix::PREFIX_66 | prefix::PREFIX_F2 | prefix::PREFIX_F3)) == 0);
    ...
    0xAE | 0x1AE => {
        ...
        match modrm_byte >> 3 & 7 {
            ...
            x => {
                dbg_log!("#ud FAE/{} at {:x}", x, *instruction_pointer);
                trigger_ud();
            }
        }
    },
    ...
    0xBA => {
        ...
        match modrm_byte >> 3 & 7 {
            ...
            x => {
                dbg_log!("#ud FBA/{} at {:x}", x, *instruction_pointer);
                trigger_ud();
            }
        }
    },
    ...
    0xC7 => {
        ...
        match modrm_byte >> 3 & 7 {
            ...
            x => {
                dbg_log!("#ud FC7/{} at {:x}", x, *instruction_pointer);
                trigger_ud();
            }
        }
    },
